...
{
    public class SupplierOrderLineEditContextValidator : AbstractValidator<SupplierOrderLineEditContext>
    {
        public SupplierOrderLineEditContextValidator()
        {
            CascadeMode = CascadeMode.Stop;

            RuleFor(ol => ol.SupplierProductId)
