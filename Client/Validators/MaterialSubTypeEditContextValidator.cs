...
{
    public class MaterialSubTypeEditContextValidator : AbstractValidator<MaterialSubTypeEditContext>
    {
        private readonly IApiService _apiService;

        public MaterialSubTypeEditContextValidator(IApiService apiService)
        {
        ...
        private async Task<bool> BeUniqueNameAsync(MaterialSubTypeEditContext model, string name,
            CancellationToken cancellationToken)
        {
            ...
            var isUnique = await _apiService.IsUniqueValueAsync(req, "api/material-sub-types/unique-validation");

            return isUnique;
        }

        private async Task<bool> BeUniqueCodeAsync(MaterialSubTypeEditContext model, string code,
            CancellationToken cancellationToken)
        {
            var req = new ValidationRequest
            {
