...
{
    public class DepartmentEditContextValidator : AbstractValidator<DepartmentEditContext>
    {
        private readonly IApiService _apiService;

        public DepartmentEditContextValidator(IApiService apiService)
        {
        ...
        private async Task<bool> BeUniqueNameAsync(DepartmentEditContext model, string name,
            CancellationToken cancellationToken)
        {
            ...
            var isUnique = await _apiService.IsUniqueValueAsync(req, "api/departments/unique-validation");
