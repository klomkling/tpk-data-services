...
{
    public class CustomerOrderLineEditContext : EditContextBase<CustomerOrderLine>
    {
        private string _amountDisplay;
        private string _netAmountDisplay;

        public CustomerOrderLineEditContext() : base(null)
        {
        }

        public CustomerOrderLineEditContext(CustomerOrderLine dataItem) : base(dataItem)
        {
            Id = DataItem.Id;
