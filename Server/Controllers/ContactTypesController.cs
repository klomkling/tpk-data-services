...
namespace Tpk.DataServices.Server.Controllers
{
    ...
    public class ContactTypesController : TgControllerBase<ContactType, ContactType>
    {
        public ContactTypesController(IServiceProvider serviceProvider, IContactTypeService contactTypeService,
            ILogger<ContactTypesController> logger)
            : base(serviceProvider, contactTypeService, logger)
        {
        }
        ...
        [HttpGet("{id:int}")]
        [ClaimRequired(RestrictItems.ContactTypes, RestrictActions.View)]
        ...
        [HttpPost]
        [ClaimRequired(RestrictItems.ContactTypes, RestrictActions.Create)]
        public override async Task<IActionResult> InsertAsync([FromBody] ContactType model)
        {
            return await base.InsertAsync(model);
        }

        [HttpPatch]
        [ClaimRequired(RestrictItems.ContactTypes, RestrictActions.Update)]
        public override async Task<IActionResult> UpdateAsync([FromBody] ContactType model)
        {
            return await base.UpdateAsync(model);
        }

        [HttpDelete]
        [ClaimRequired(RestrictItems.ContactTypes, RestrictActions.Delete)]
