...
namespace Tpk.DataServices.Server.Controllers
{
    ...
    public class ProductColorsController : TgControllerBase<ProductColor, ProductColor>
    {
        public ProductColorsController(IServiceProvider serviceProvider, IProductColorService colorService,
            ILogger<ProductColorsController> logger)
            : base(serviceProvider, colorService, logger)
        {
        }
        ...
        public override async Task<IActionResult> InsertAsync([FromBody] ProductColor model)
        {
        ...
        public override async Task<IActionResult> UpdateAsync([FromBody] ProductColor model)
        {
