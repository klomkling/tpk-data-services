...
namespace Tpk.DataServices.Server.Controllers
{
    ...
    public class UnitsController : TgControllerBase<Unit, Unit>
    {
        public UnitsController(IServiceProvider serviceProvider, IUnitService unitService,
            ILogger<UnitsController> logger)
            : base(serviceProvider, unitService, logger)
        {
        }
        ...
        [HttpPost]
        [ClaimRequired(RestrictItems.Units, RestrictActions.Create)]
        public override async Task<IActionResult> InsertAsync([FromBody] Unit model)
        {
            return await base.InsertAsync(model);
        }

        [HttpPatch]
        [ClaimRequired(RestrictItems.Units, RestrictActions.Update)]
        public override async Task<IActionResult> UpdateAsync([FromBody] Unit model)
        {
            return await base.UpdateAsync(model);
        }

        [HttpDelete]
        [ClaimRequired(RestrictItems.Units, RestrictActions.Delete)]
