...
namespace Tpk.DataServices.Server.Controllers
{
    [AuthorizeRequired]
    [ApiController]
    [Route("api/transportation-request-lines")]
    public class
        TransportationRequestLinesController : TgControllerBase<TransportationRequestLineWithDetail,
            TransportationRequestLine>
    {
        public TransportationRequestLinesController(IServiceProvider serviceProvider,
            ITransportationRequestLineService transportationRequestLineService,
            ILogger<TransportationRequestLinesController> logger)
            : base(serviceProvider, transportationRequestLineService, logger)
        {
        }
        ...
        public override async Task<IActionResult> InsertAsync([FromBody] TransportationRequestLine model)
        {
        ...
        public override async Task<IActionResult> UpdateAsync([FromBody] TransportationRequestLine model)
        {
