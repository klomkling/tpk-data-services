...
namespace Tpk.DataServices.Server.Controllers
{
    ...
    public class SectionsController : TgControllerBase<Section, Section>
    {
        public SectionsController(IServiceProvider serviceProvider, ISectionService sectionService,
            ILogger<SectionsController> logger)
            : base(serviceProvider, sectionService, logger)
        {
        }
        ...
        [HttpPost]
        [ClaimRequired(RestrictItems.Sections, RestrictActions.Create)]
        public override async Task<IActionResult> InsertAsync([FromBody] Section model)
        {
            return await base.InsertAsync(model);
        }

        [HttpPatch]
        [ClaimRequired(RestrictItems.Sections, RestrictActions.Update)]
        public override async Task<IActionResult> UpdateAsync([FromBody] Section model)
        {
            return await base.UpdateAsync(model);
        }

        [HttpDelete]
        [ClaimRequired(RestrictItems.Sections, RestrictActions.Delete)]
